...
data class Device(
    ...
    @XmlElement(true) @SerialName("productid") val productId: String?,
    @XmlElement(true) @SerialName("deviceserial") val deviceSerial: String?,
    ...
    @XmlElement(true) @SerialName("tidaloauthversion") val tidalOAuthVersion: Int?,
