...
@Serializable
@SerialName("ZBlind")
data class ZBlindConfig(
    override val name: String,
    override val deviceId: String,
    override val prefix: String = "zigbee"
) : IAlleyConfig<BlindState>,
    IZigbeeConfig<BlindState>,
    IConfigEditable<ZBlindConfig> by SimpleConfigEditable(
        listOf(
            ZBlindConfig::name.fieldEditor("Name") { c, n -> c.copy(name = n) },
            ZBlindConfig::prefix.fieldEditor("MQTT Prefix") { c, n -> c.copy(prefix = n) }
        )
    ) {
